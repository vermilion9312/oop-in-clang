...
clean-User-2f-Src:
	-$(RM) ./User/Src/app_main.cyclo ./User/Src/app_main.d ./User/Src/app_main.o ./User/Src/app_main.su ./User/Src/input.cyclo ./User/Src/input.d ./User/Src/input.o ./User/Src/input.su ./User/Src/output.cyclo ./User/Src/output.d ./User/Src/output.o ./User/Src/output.su ./User/Src/segment.cyclo ./User/Src/segment.d ./User/Src/segment.o ./User/Src/segment.su ./User/Src/timer.cyclo ./User/Src/timer.d ./User/Src/timer.o ./User/Src/timer.su
