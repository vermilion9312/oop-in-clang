...
clean-User-2f-Src:
	-$(RM) ./User/Src/app_main.cyclo ./User/Src/app_main.d ./User/Src/app_main.o ./User/Src/app_main.su ./User/Src/input.cyclo ./User/Src/input.d ./User/Src/input.o ./User/Src/input.su ./User/Src/led_manager.cyclo ./User/Src/led_manager.d ./User/Src/led_manager.o ./User/Src/led_manager.su ./User/Src/output.cyclo ./User/Src/output.d ./User/Src/output.o ./User/Src/output.su
